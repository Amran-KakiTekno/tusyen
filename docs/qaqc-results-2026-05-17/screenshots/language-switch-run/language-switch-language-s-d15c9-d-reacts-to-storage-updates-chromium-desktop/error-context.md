...
- Name: language-switch.spec.ts >> language switching - cross-tab persistence >> language persists across tabs and reacts to storage updates
- Location: tests\qaqc\language-switch.spec.ts:477:7
